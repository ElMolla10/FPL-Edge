...
import { ManagerMeta, OfficialPick, evaluateSandbox, deriveSandboxFinancialContext, sellingPricesFor } from "../lib/squad-comparison";
...
function Transfers({data,go,revision,onTeamChange,fullDesk,onUpgrade}:{data:FplData;go:(v:View)=>void;revision:number;onTeamChange:()=>void;fullDesk:boolean;onUpgrade:()=>void}){
  ...
  const baseRows=useMemo(()=>a?bestTransfers(data,squad,bank,fts,60,sellingPrices):[],[data,squad,bank,fts,a,sellingPrices]);
