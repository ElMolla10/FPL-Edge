...
export default function LiveDraftBuilder({ explorer = false }: { explorer?: boolean }) {
  ...
  return <div className="live-builder">
    ...
    {sandbox&&sandboxComparisons&&latestSandboxTransfer&&<SandboxImpactPanel comparison={sandboxComparisons} latestTransfer={latestSandboxTransfer} freeTransfers={freeTransfers} onUndo={undoLastTransfer} onReset={resetAllTransfers} confidenceInput={{data,futureEventIds:eventIds,sandbox,settingsKey:`${horizonMode}|${riskMode}|${philosophy}`}}/>}
