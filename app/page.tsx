...
export default function Home() {
  ...
  return <main className="marketing-page">
    ...
    <footer><div className="footer-cta"><p>YOUR NEXT DEADLINE STARTS HERE</p><h2>Make the move<br /><em>you can defend.</em></h2><button className="btn btn-primary" onClick={() => setDemoMode(true)}>Get my gameweek plan →</button></div><div className="footer-bottom"><span>FPL EDGE</span><p>Independent FPL decision assistant. Not affiliated with or endorsed by the Premier League.</p><span>© 2026</span></div></footer>
  </main>;
}
